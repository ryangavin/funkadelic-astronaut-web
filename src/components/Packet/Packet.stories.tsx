...
import { BAND_MEMBER_PACKETS } from './bandMembers';
import { Packet } from './Packet';

const [ryan, kevin, sam] = BAND_MEMBER_PACKETS;

const meta = {
  title: 'Components/Packet',
  component: Packet,
  ...
  args: { photo: ryan.photo, card: ryan.card, photoSide: 'right', photoWidth: 220, photoTop: 36, photoRotation: 5, clip: true, clipAt: 58, clipRotation: 8 },
  decorators: [
    (Story) => (
...
export const Members: Story = {
  render: (args) => (
    <div style={{ display: 'grid', gap: 40 }}>
      ...
      <Packet {...args} photo={kevin.photo} card={kevin.card} photoRotation={-3} clipAt={148} clipRotation={-4} />
      <Packet {...args} photo={sam.photo} card={sam.card} photoRotation={7} clipAt={104} clipRotation={4} />
    </div>
  ),
};
