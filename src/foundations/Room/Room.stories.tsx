...
const meta = {
  ...
  argTypes: {
    ...
    lampLowerAngle: { control: { type: 'range', min: -180, max: 180, step: .1 }, table: { category: 'Lamp articulation' } },
    lampUpperAngle: { control: { type: 'range', min: -180, max: 180, step: .1 }, table: { category: 'Lamp articulation' } },
  ...
  args: { angle: 78, depth: 5700, wood: 'walnut', room: true, floor: 'pine', wall: 'red', lamp: true, shadowStrength: .36, lampX: 396, lampY: 17, lampRotation: 0, lampWidth: 576, lampEnamel: 'green', lampLowerAngle: -142.6818247177271, lampUpperAngle: 110.41274403236815, onArrange: fn(), onArticulate: fn(), onLamp: fn() },
